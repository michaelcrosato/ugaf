...
const PERSONAS: Persona[] = [
  {
    ...
    commands: [
      ...
      'out',
      'talk to holt',
      'ask holt about the greywater',
      'ask holt about the mile road',
      'road',
      'talk to lyle',
      'ask lyle about the core',
      'road',
  ...
  },
  {
    ...
    commands: [
      ...
      'survey',
      'talk to eun',
      'ask eun about the greywater',
      'bribe eun',
      'out',
      'salvage',
      'talk to mox',
      'ask mox about the core',
      'bribe mox',
      'out',
      'road',
      'on',
